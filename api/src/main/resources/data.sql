...
INSERT INTO announce (a_titre, a_message, a_level, a_plateforme, a_user_id, a_game_id) VALUES
...
"user" u WHERE u.u_id = 3), (SELECT a.a_id FROM announce a WHERE a.a_id = 1)),
